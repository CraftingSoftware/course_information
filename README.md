...
6      | Oct. 3 - Oct. 7       | Digital Ocean Hacktoberfest. Continuous Integration and Delivery.   | <ul><li>Project 1 Stand-Ups.</li> <li>Activty 5 - CI. | <ul><li>Pandas Data Frame</li> <li>Software Engineering at Google: [Continuous Integration](https://abseil.io/resources/swe-book/html/ch23.html).</li></ul>
