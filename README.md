...
4      | Sep. 19 - Sep. 23     | [Writing Tests](https://docs.google.com/presentation/d/e/2PACX-1vRjjeGm8Of6k8ZDpTw8FE6DgizahwSUf_qkdg4pIGOnMX-Meq4eCoxldsvEx2_o3Q/pub?start=false&loop=false&delayms=3000). Processes within Software Engineering Organizations. Project Tool Introduction. | [Writing maintainable tests assignment](https://classroom.github.com/a/gKmCZgAp). | Python Testing with pytest: [Chapters 1-2](https://drive.google.com/file/d/1FY-JPjZe1BXUdC0ebKvJfsWIdNS0yRUM/view?usp=sharing). Software Engineering at Google: [Unit Testing](https://abseil.io/resources/swe-book/html/ch12.html).
5      | Sep. 26 - Sep. 30     | Communication. Continuous Integration and Delivery. Project 1 released.                               |           | 
6      | Oct. 3 - Oct. 7       | Requirements Engineering.                           |           | 
