...
6      | Oct. 3 - Oct. 7       | Digital Ocean Hacktoberfest. Continuous Integration and Delivery.   | <ul><li>Project 1 Stand-Ups.</li> <li>Activity 5 - CI.</li></ul> | <ul><li>[Pandas Data Frame](https://realpython.com/pandas-dataframe/).</li> <li>Software Engineering at Google: [Continuous Integration.](https://abseil.io/resources/swe-book/html/ch23.html).</li></ul>
